...
public class LinkedList<T extends Comparable<T>> {
    ...
    /**
     * Filters elements of the list based on the given predicate.
     *
    ...
    /**
     * Applies the given consumer to all elements of the list.
     *
     * @param consumer The consumer to apply to elements.
     */
    ...
    /**
     * Adds an element if it matches the given predicate.
     *
     * @param item The element to add.
     * @param predicate The predicate to match the element.
     */
    public void addIf(T item, Predicate<T> predicate) {
